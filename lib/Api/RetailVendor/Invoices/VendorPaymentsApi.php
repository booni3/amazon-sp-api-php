...
namespace ClouSale\AmazonSellingPartnerAPI\Api\RetailVendor\Invoices;
...
class VendorPaymentsApi
{
     ...
     *
     * @param  \ClouSale\AmazonSellingPartnerAPI\Models\RetailVendor\Invoices\SubmitInvoicesRequest $body body (required)
     *
     * @throws \ClouSale\AmazonSellingPartnerAPI\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \ClouSale\AmazonSellingPartnerAPI\Models\RetailVendor\Invoices\SubmitInvoicesResponse
     */
     ...
     *
     * @param  \ClouSale\AmazonSellingPartnerAPI\Models\RetailVendor\Invoices\SubmitInvoicesRequest $body (required)
     *
     * @throws \ClouSale\AmazonSellingPartnerAPI\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ClouSale\AmazonSellingPartnerAPI\Models\RetailVendor\Invoices\SubmitInvoicesResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function submitInvoicesWithHttpInfo($body)
    {
        $returnType = '\ClouSale\AmazonSellingPartnerAPI\Models\RetailVendor\Invoices\SubmitInvoicesResponse';
            ...
            switch ($e->getCode()) {
                case 202:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\ClouSale\AmazonSellingPartnerAPI\Models\RetailVendor\Invoices\SubmitInvoicesResponse',
