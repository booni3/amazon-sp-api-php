...
namespace ClouSale\AmazonSellingPartnerAPI\Api\RetailVendor\Shipments;
...
class VendorShippingApi
{
     ...
     *
     * @param  \ClouSale\AmazonSellingPartnerAPI\Models\RetailVendor\Shipments\SubmitShipmentConfirmationsRequest $body body (required)
     *
     * @throws \ClouSale\AmazonSellingPartnerAPI\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \ClouSale\AmazonSellingPartnerAPI\Models\RetailVendor\Shipments\SubmitShipmentConfirmationsResponse
     */
     ...
     *
     * @param  \ClouSale\AmazonSellingPartnerAPI\Models\RetailVendor\Shipments\SubmitShipmentConfirmationsRequest $body (required)
     *
     * @throws \ClouSale\AmazonSellingPartnerAPI\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ClouSale\AmazonSellingPartnerAPI\Models\RetailVendor\Shipments\SubmitShipmentConfirmationsResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function submitShipmentConfirmationsWithHttpInfo($body)
    {
        $returnType = '\ClouSale\AmazonSellingPartnerAPI\Models\RetailVendor\Shipments\SubmitShipmentConfirmationsResponse';
            ...
            switch ($e->getCode()) {
                case 202:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\ClouSale\AmazonSellingPartnerAPI\Models\RetailVendor\Shipments\SubmitShipmentConfirmationsResponse',
