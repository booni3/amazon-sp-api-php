...
namespace ClouSale\AmazonSellingPartnerAPI\Api\DirectFulfillmentVendor\Transactions;
...
class VendorTransactionApi
{
     ...
     *
     * @param  string $transaction_id The GUID sent in the &#x27;transactionId&#x27; field in response to the post request of a specific transaction. (required)
     *
     * @throws \ClouSale\AmazonSellingPartnerAPI\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \ClouSale\AmazonSellingPartnerAPI\Models\DirectFulfillmentVendor\Transactions\GetTransactionResponse
     */
     ...
     * @throws \ClouSale\AmazonSellingPartnerAPI\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ClouSale\AmazonSellingPartnerAPI\Models\DirectFulfillmentVendor\Transactions\GetTransactionResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getTransactionStatusWithHttpInfo($transaction_id)
    {
        $returnType = '\ClouSale\AmazonSellingPartnerAPI\Models\DirectFulfillmentVendor\Transactions\GetTransactionResponse';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\ClouSale\AmazonSellingPartnerAPI\Models\DirectFulfillmentVendor\Transactions\GetTransactionResponse',
