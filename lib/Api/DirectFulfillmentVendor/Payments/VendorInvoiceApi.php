...
namespace ClouSale\AmazonSellingPartnerAPI\Api\DirectFulfillmentVendor\Payments;
...
class VendorInvoiceApi
{
     ...
     *
     * @param  \ClouSale\AmazonSellingPartnerAPI\Models\DirectFulfillmentVendor\Payments\SubmitInvoiceRequest $body body (required)
     *
     * @throws \ClouSale\AmazonSellingPartnerAPI\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \ClouSale\AmazonSellingPartnerAPI\Models\DirectFulfillmentVendor\Payments\SubmitInvoiceResponse
     */
     ...
     *
     * @param  \ClouSale\AmazonSellingPartnerAPI\Models\DirectFulfillmentVendor\Payments\SubmitInvoiceRequest $body (required)
     *
     * @throws \ClouSale\AmazonSellingPartnerAPI\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ClouSale\AmazonSellingPartnerAPI\Models\DirectFulfillmentVendor\Payments\SubmitInvoiceResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function submitInvoiceWithHttpInfo($body)
    {
        $returnType = '\ClouSale\AmazonSellingPartnerAPI\Models\DirectFulfillmentVendor\Payments\SubmitInvoiceResponse';
            ...
            switch ($e->getCode()) {
                case 202:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\ClouSale\AmazonSellingPartnerAPI\Models\DirectFulfillmentVendor\Payments\SubmitInvoiceResponse',
