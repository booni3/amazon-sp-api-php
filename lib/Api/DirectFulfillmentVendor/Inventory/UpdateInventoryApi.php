...
namespace ClouSale\AmazonSellingPartnerAPI\Api\DirectFulfillmentVendor\Inventory;
...
class UpdateInventoryApi
{
     ...
     *
     * @param  \ClouSale\AmazonSellingPartnerAPI\Models\DirectFulfillmentVendor\Inventory\SubmitInventoryUpdateRequest $body body (required)
     * @param  string $warehouse_id Warehouse Id for which the details needs to be updated. (required)
     *
     * @throws \ClouSale\AmazonSellingPartnerAPI\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \ClouSale\AmazonSellingPartnerAPI\Models\DirectFulfillmentVendor\Inventory\SubmitInventoryUpdateResponse
     */
     ...
     *
     * @param  \ClouSale\AmazonSellingPartnerAPI\Models\DirectFulfillmentVendor\Inventory\SubmitInventoryUpdateRequest $body (required)
     * @param  string $warehouse_id Warehouse Id for which the details needs to be updated. (required)
     *
     * @throws \ClouSale\AmazonSellingPartnerAPI\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ClouSale\AmazonSellingPartnerAPI\Models\DirectFulfillmentVendor\Inventory\SubmitInventoryUpdateResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function submitInventoryUpdateWithHttpInfo($body, $warehouse_id)
    {
        $returnType = '\ClouSale\AmazonSellingPartnerAPI\Models\DirectFulfillmentVendor\Inventory\SubmitInventoryUpdateResponse';
            ...
            switch ($e->getCode()) {
                case 202:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\ClouSale\AmazonSellingPartnerAPI\Models\DirectFulfillmentVendor\Inventory\SubmitInventoryUpdateResponse',
