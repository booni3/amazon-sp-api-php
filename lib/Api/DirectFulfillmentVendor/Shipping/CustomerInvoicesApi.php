...
class CustomerInvoicesApi
{
     ...
     *
     * @param  string $purchase_order_number Purchase order number of shipment for which the details needs to be fetched. (required)
     *
     * @throws \ClouSale\AmazonSellingPartnerAPI\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \ClouSale\AmazonSellingPartnerAPI\Models\DirectFulfillmentVendor\Shipping\GetCustomerInvoiceResponse
     */
     ...
     * @throws \ClouSale\AmazonSellingPartnerAPI\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ClouSale\AmazonSellingPartnerAPI\Models\DirectFulfillmentVendor\Shipping\GetCustomerInvoiceResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getCustomerInvoiceWithHttpInfo($purchase_order_number)
    {
        $returnType = '\ClouSale\AmazonSellingPartnerAPI\Models\DirectFulfillmentVendor\Shipping\GetCustomerInvoiceResponse';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\ClouSale\AmazonSellingPartnerAPI\Models\DirectFulfillmentVendor\Shipping\GetCustomerInvoiceResponse',
     ...
     * @throws \ClouSale\AmazonSellingPartnerAPI\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \ClouSale\AmazonSellingPartnerAPI\Models\DirectFulfillmentVendor\Shipping\GetCustomerInvoicesResponse
     */
     ...
     * @throws \ClouSale\AmazonSellingPartnerAPI\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ClouSale\AmazonSellingPartnerAPI\Models\DirectFulfillmentVendor\Shipping\GetCustomerInvoicesResponse, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    {
        $returnType = '\ClouSale\AmazonSellingPartnerAPI\Models\DirectFulfillmentVendor\Shipping\GetCustomerInvoicesResponse';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\ClouSale\AmazonSellingPartnerAPI\Models\DirectFulfillmentVendor\Shipping\GetCustomerInvoicesResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
