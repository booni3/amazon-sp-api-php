...
namespace ClouSale\AmazonSellingPartnerAPI\Api\DirectFulfillmentVendor\Orders;
...
class VendorOrdersApi
{
     ...
     * Operation getOrder
     *
     * @param  string $purchase_order_number Order Id for which the details needs to be fetched. Formatting Notes: alpha-numeric code (required)
     *
     * @throws \ClouSale\AmazonSellingPartnerAPI\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \ClouSale\AmazonSellingPartnerAPI\Models\DirectFulfillmentVendor\Orders\GetOrderResponse
     */
     ...
     * @throws \ClouSale\AmazonSellingPartnerAPI\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ClouSale\AmazonSellingPartnerAPI\Models\DirectFulfillmentVendor\Orders\GetOrderResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getOrderWithHttpInfo($purchase_order_number)
    {
        $returnType = '\ClouSale\AmazonSellingPartnerAPI\Models\DirectFulfillmentVendor\Orders\GetOrderResponse';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\ClouSale\AmazonSellingPartnerAPI\Models\DirectFulfillmentVendor\Orders\GetOrderResponse',
     ...
     * Operation getOrders
     *
     * @param  \DateTime $created_after Orders that became available after this time will be included in the result. Date range to search must not be more than 7 days.This field is expected to be in ISO-8601 date/time format, for example:2018-07-16T23:00:00Z/ 2018-07-16T23:00:00-05:00 /2018-07-16T23:00:00-08:00 (required)
     * @param  \DateTime $created_before Orders that became available before this time will be included in the result. Date range to search must not be more than 7 days.This field is expected to be in ISO-8601 date/time format, for example:2018-07-16T23:00:00Z/ 2018-07-16T23:00:00-05:00 /2018-07-16T23:00:00-08:00 (required)
     ...
     * @param  string $status Returns only orders that belong to this status. If not specified the result will contain orders in any status. (optional)
     ...
     * @param  string $include_details Default value is true. If entered as &#x27;true&#x27;, this API will return list of orders with complete details. If entered as &#x27;false&#x27; or not included in filter, then only purchase order numbers are returned. (optional, default to true)
     *
     * @throws \ClouSale\AmazonSellingPartnerAPI\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \ClouSale\AmazonSellingPartnerAPI\Models\DirectFulfillmentVendor\Orders\GetOrdersResponse
     */
     ...
     * @throws \ClouSale\AmazonSellingPartnerAPI\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ClouSale\AmazonSellingPartnerAPI\Models\DirectFulfillmentVendor\Orders\GetOrdersResponse, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    {
        $returnType = '\ClouSale\AmazonSellingPartnerAPI\Models\DirectFulfillmentVendor\Orders\GetOrdersResponse';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\ClouSale\AmazonSellingPartnerAPI\Models\DirectFulfillmentVendor\Orders\GetOrdersResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  \ClouSale\AmazonSellingPartnerAPI\Models\DirectFulfillmentVendor\Orders\OrderAcknowledgements $body body (required)
     *
     * @throws \ClouSale\AmazonSellingPartnerAPI\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \ClouSale\AmazonSellingPartnerAPI\Models\DirectFulfillmentVendor\Orders\SubmitAcknowledgementResponse
     */
     ...
     *
     * @param  \ClouSale\AmazonSellingPartnerAPI\Models\DirectFulfillmentVendor\Orders\OrderAcknowledgements $body (required)
     *
     * @throws \ClouSale\AmazonSellingPartnerAPI\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ClouSale\AmazonSellingPartnerAPI\Models\DirectFulfillmentVendor\Orders\SubmitAcknowledgementResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function submitAcknowledgementWithHttpInfo($body)
    {
        $returnType = '\ClouSale\AmazonSellingPartnerAPI\Models\DirectFulfillmentVendor\Orders\SubmitAcknowledgementResponse';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 202:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\ClouSale\AmazonSellingPartnerAPI\Models\DirectFulfillmentVendor\Orders\SubmitAcknowledgementResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
