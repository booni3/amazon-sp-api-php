...
'description' => 'getDescription'    ];
     ...
     * Sets code
     *
     * @param string $code Acknowledge code is a unique two digit value which indicates the status of acknowledgement. To see the list of acknowledgement codes Amazon supports, please refer the business use case documentation for this API.
     *
     * @return $this
     */
