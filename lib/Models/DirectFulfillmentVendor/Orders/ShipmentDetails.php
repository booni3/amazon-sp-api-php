...
'is_gift' => 'bool',
'ship_method' => 'string',
'shipment_dates' => '\ClouSale\AmazonSellingPartnerAPI\Models\DirectFulfillmentVendor\Orders\ShipmentDates',
...
'message_to_customer' => 'getMessageToCustomer'    ];
     ...
     *
     * @param bool $is_priority_shipment Is this a priority shipment.
     *
     * @return $this
     */
     ...
     *
     * @param bool $is_scheduled_delivery_shipment Is this order part of scheduled delivery program
     *
     * @return $this
     */
     ...
     *
     * @param bool $is_pslip_required Is Packing Slip required to be sent to customer (true/false).
     *
     * @return $this
     */
     ...
     * Sets is_gift
     *
     * @param bool $is_gift Does this order contain a gift. If yes, then use the gift message and gift wrap information.
     *
     * @return $this
     */
     ...
     * Sets ship_method
     *
     * @param string $ship_method Ship method to be used for shipping the order.Amazon defines Ship Method Codes indicating shipping carrier and shipment service level.To see the full list of ship methods in use -- including both the code and the friendly name -- search the 'Help' section on Vendor Central for 'ship methods'.
     *
     * @return $this
     */
     ...
     * Gets shipment_dates
     *
     * @return \ClouSale\AmazonSellingPartnerAPI\Models\DirectFulfillmentVendor\Orders\ShipmentDates
     */
     ...
     * Sets shipment_dates
     *
     * @param \ClouSale\AmazonSellingPartnerAPI\Models\DirectFulfillmentVendor\Orders\ShipmentDates $shipment_dates shipment_dates
     *
     * @return $this
     */
