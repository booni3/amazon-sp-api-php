...
class TransactionReference implements ModelInterface, ArrayAccess
{
     ...
     * Sets transaction_id
     *
     * @param string $transaction_id An unique identifier to identify this transaction. It will be used in Transaction Status API as a reference to get status of this transaction.
     *
     * @return $this
     */
