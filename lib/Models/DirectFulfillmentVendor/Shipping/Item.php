...
'shipped_quantity' => '\ClouSale\AmazonSellingPartnerAPI\Models\DirectFulfillmentVendor\Shipping\ItemQuantity'    ];
...
'shipped_quantity' => 'getShippedQuantity'    ];
     ...
     *
     * @param int $item_sequence_number Item Sequence Number for the item.This must be the same value as sent in order message for a given item.
     *
     * @return $this
     */
     ...
     *
     * @return \ClouSale\AmazonSellingPartnerAPI\Models\DirectFulfillmentVendor\Shipping\ItemQuantity
     */
     ...
     *
     * @param \ClouSale\AmazonSellingPartnerAPI\Models\DirectFulfillmentVendor\Shipping\ItemQuantity $shipped_quantity shipped_quantity
     *
     * @return $this
     */
