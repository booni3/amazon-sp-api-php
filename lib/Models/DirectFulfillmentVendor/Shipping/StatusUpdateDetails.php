...
'status_location_address' => '\ClouSale\AmazonSellingPartnerAPI\Models\DirectFulfillmentVendor\Shipping\Address',
'shipment_schedule' => '\ClouSale\AmazonSellingPartnerAPI\Models\DirectFulfillmentVendor\Shipping\StatusUpdateDetailsShipmentSchedule'    ];
...
'shipment_schedule' => 'getShipmentSchedule'    ];
     ...
     * Sets reason_code
     *
     * @param string $reason_code Provides a reason code for the status of the package that will provide additional information about the transporation status
     *
     * @return $this
     */
     ...
     *
     * @param \DateTime $status_date_time This field indicates the date of the shipment status message and thus the date-time when the shipment status was updated. This field is expected to be in ISO-8601 date/time format, with UTC timezone or UTC offset for example:2020-07-16T23:00:00Z or 2020-07-16T23:00:00+01:00.
     *
     * @return $this
     */
     ...
     *
     * @return \ClouSale\AmazonSellingPartnerAPI\Models\DirectFulfillmentVendor\Shipping\Address
     */
     ...
     *
     * @param \ClouSale\AmazonSellingPartnerAPI\Models\DirectFulfillmentVendor\Shipping\Address $status_location_address status_location_address
     *
     * @return $this
     */
     ...
     *
     * @return \ClouSale\AmazonSellingPartnerAPI\Models\DirectFulfillmentVendor\Shipping\StatusUpdateDetailsShipmentSchedule
     */
     ...
     *
     * @param \ClouSale\AmazonSellingPartnerAPI\Models\DirectFulfillmentVendor\Shipping\StatusUpdateDetailsShipmentSchedule $shipment_schedule shipment_schedule
     *
     * @return $this
     */
