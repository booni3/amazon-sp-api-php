 ...
 *
 * @category Class
 * @description Details of the item in inventory.
 * @package  ClouSale\AmazonSellingPartnerAPI
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
...
'available_quantity' => '\ClouSale\AmazonSellingPartnerAPI\Models\DirectFulfillmentVendor\Inventory\ItemQuantity',
'is_obsolete' => 'bool'    ];
...
'is_obsolete' => 'getIsObsolete'    ];
     ...
     *
     * @param string $buyer_product_identifier The buyer selected product identification of the item. Either buyerProductIdentifier or vendorProductIdentifier should be submitted in the message.
     *
     * @return $this
     */
     ...
     *
     * @param string $vendor_product_identifier The vendor selected product identification of the item. Either buyerProductIdentifier or vendorProductIdentifier should be submitted in the message.
     *
     * @return $this
     */
     ...
     *
     * @return \ClouSale\AmazonSellingPartnerAPI\Models\DirectFulfillmentVendor\Inventory\ItemQuantity
     */
     ...
     *
     * @param \ClouSale\AmazonSellingPartnerAPI\Models\DirectFulfillmentVendor\Inventory\ItemQuantity $available_quantity available_quantity
     *
     * @return $this
     */
     ...
     * Sets is_obsolete
     *
     * @param bool $is_obsolete To mark an item permanently unavailable (true/false) for items vendor doesn’t sell anymore.
     *
     * @return $this
     */
