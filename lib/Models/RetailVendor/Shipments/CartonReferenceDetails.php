...
'carton_reference_numbers' => 'getCartonReferenceNumbers'    ];
     ...
     *
     * @param string[] $carton_reference_numbers Array of reference numbers for the carton that are part of this Pallet/Shipment. Please provide the cartonSequenceNumber from the 'cartons' segment to refer to that carton details here.
     *
     * @return $this
     */
