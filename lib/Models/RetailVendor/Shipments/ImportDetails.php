...
'seal_number' => 'string',
'route' => '\ClouSale\AmazonSellingPartnerAPI\Models\RetailVendor\Shipments\Route',
'import_containers' => 'string',
'billable_weight' => '\ClouSale\AmazonSellingPartnerAPI\Models\RetailVendor\Shipments\Weight',
...
self::METHOD_OF_PAYMENT_PAID_BY_SELLER,        ];
     ...
     * Sets seal_number
     *
     * @param string $seal_number This field indicates the container's seal number.
     *
     * @return $this
     */
     ...
     * Gets route
     *
     * @return \ClouSale\AmazonSellingPartnerAPI\Models\RetailVendor\Shipments\Route
     */
     ...
     * Sets route
     *
     * @param \ClouSale\AmazonSellingPartnerAPI\Models\RetailVendor\Shipments\Route $route route
     *
     * @return $this
     */
     ...
     *
     * @param string $import_containers Types and numbers of container(s) for import POs. Can be a comma-separated list if shipment has multiple containers.
     *
     * @return $this
     */
     ...
     *
     * @param \ClouSale\AmazonSellingPartnerAPI\Models\RetailVendor\Shipments\Weight $billable_weight billable_weight
     *
     * @return $this
     */
     ...
     *
     * @param \DateTime $estimated_ship_by_date Date on which the Shipment is expected to be shipped. This value  should not be in the past or not more than 60 days out in the  future. Refer to dateTimeDetails for formatting notes.
     *
     * @return $this
     */
