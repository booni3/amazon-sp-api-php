...
self::CONTAINER_IDENTIFICATION_TYPE_CID,        ];
     ...
     *
     * @param string $container_identification_type | Container Identification Type | Definition | | ----------------------------- | -----------| | SSCC |  2 Digit Application Identifier (00) followed by Unique 18-digit Serial Shipment Container Code (SSCC) to be included to define a pallet/carton and to identify its contents| | AMZNCC | Amazon Container Code - a substitute for an SSCC generated by Amazon for small vendors, associated with a pallet/carton label| | GTIN | Global Trade Identification Number (part of the standard GS1 barcoding and product identification system) |   | BPS | Barcode Packing Slip  |  | CID | Container Identifier for import shipments |
     *
     * @return $this
     */
