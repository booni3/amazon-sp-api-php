...
class ShipmentMeasurements implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'gross_shipment_weight' => '\ClouSale\AmazonSellingPartnerAPI\Models\RetailVendor\Shipments\Weight',
'shipment_volume' => '\ClouSale\AmazonSellingPartnerAPI\Models\RetailVendor\Shipments\Volume',
'carton_count' => 'int',
'pallet_count' => 'int'    ];
...
'pallet_count' => 'getPalletCount'    ];
     ...
     *
     * @param \ClouSale\AmazonSellingPartnerAPI\Models\RetailVendor\Shipments\Weight $gross_shipment_weight gross_shipment_weight
     *
     * @return $this
     */
     ...
     *
     * @return \ClouSale\AmazonSellingPartnerAPI\Models\RetailVendor\Shipments\Volume
     */
     ...
     *
     * @param \ClouSale\AmazonSellingPartnerAPI\Models\RetailVendor\Shipments\Volume $shipment_volume shipment_volume
     *
     * @return $this
     */
     ...
     * Sets carton_count
     *
     * @param int $carton_count Number of cartons present in the shipment. Provide the cartonCount only for unpalletized Shipments. In other cases, do not send this field.
     *
     * @return $this
     */
     ...
     * Sets pallet_count
     *
     * @param int $pallet_count Number of pallets present in the shipment. Provide the palletCount only for palletized Shipments. In other cases, do not send this field.
     *
     * @return $this
     */
