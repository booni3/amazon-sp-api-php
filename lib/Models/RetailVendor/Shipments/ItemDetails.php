 ...
 *
 * @category Class
 * @description Provide these fields for every item in shipment at either the item or carton or pallet level, which ever is appropriate.
 * @package  ClouSale\AmazonSellingPartnerAPI
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
...
'lot_number' => 'string',
'expiry' => '\ClouSale\AmazonSellingPartnerAPI\Models\RetailVendor\Shipments\Expiry',
'maximum_retail_price' => '\ClouSale\AmazonSellingPartnerAPI\Models\RetailVendor\Shipments\Money',
...
self::HANDLING_CODE_HANDLE_WITH_CARE,        ];
     ...
     *
     * @param string $purchase_order_number This field will be the Amazon Purchase Order number that this message is confirming the shipment for. If the items in this shipment belong to multiple Purchase Order Number, that are in particular carton or pallet within the shipment, then provide the purchaseOrderNumber at the appropriate carton or pallet level. Formatting Notes: 8-character alpha-numeric code.
     *
     * @return $this
     */
     ...
     * Gets expiry
     *
     * @return \ClouSale\AmazonSellingPartnerAPI\Models\RetailVendor\Shipments\Expiry
     */
     ...
     * Sets expiry
     *
     * @param \ClouSale\AmazonSellingPartnerAPI\Models\RetailVendor\Shipments\Expiry $expiry expiry
     *
     * @return $this
     */
     ...
     *
     * @return \ClouSale\AmazonSellingPartnerAPI\Models\RetailVendor\Shipments\Money
     */
     ...
     *
     * @param \ClouSale\AmazonSellingPartnerAPI\Models\RetailVendor\Shipments\Money $maximum_retail_price maximum_retail_price
     *
     * @return $this
     */
