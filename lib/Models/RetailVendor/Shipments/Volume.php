...
'value' => '\ClouSale\AmazonSellingPartnerAPI\Models\RetailVendor\Shipments\Decimal'    ];
...
self::UNIT_OF_MEASURE_CU_Y,        ];
     ...
     *
     * @param string $unit_of_measure The unit of measurement. Enum of CF (Cubic Feet), CI (Cubic Inches), CR (Cubic Meter) and CY (Cubic Yard).
     *
     * @return $this
     */
     ...
     * Sets value
     *
     * @param \ClouSale\AmazonSellingPartnerAPI\Models\RetailVendor\Shipments\Decimal $value value
     *
     * @return $this
     */
