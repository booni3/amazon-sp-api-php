...
'goods_return_date' => '\ClouSale\AmazonSellingPartnerAPI\Models\RetailVendor\Invoices\\DateTime',
'rma_id' => 'string',
...
'consignors_reference_number' => 'getConsignorsReferenceNumber'    ];
     ...
     *
     * @param string $returns_reference_number This field identifies the Returns Notice Number. Mandatory for all Returns Credit Notes.
     *
     * @return $this
     */
     ...
     *
     * @param \ClouSale\AmazonSellingPartnerAPI\Models\RetailVendor\Invoices\\DateTime $goods_return_date goods_return_date
     *
     * @return $this
     */
     ...
     * Sets rma_id
     *
     * @param string $rma_id This field identifies the Returned Merchandise Authorization ID if generated.
     *
     * @return $this
     */
     ...
     *
     * @param string $coop_reference_number This field identifies the COOP reference used for COOP agreement. Failure to provide the COOP reference number or the Debit Note number may lead to a rejection of the Credit Note.
     *
     * @return $this
     */
     ...
     *
     * @param string $consignors_reference_number This field identifies the consignor reference number (VRET number) if generated by Amazon.
     *
     * @return $this
     */
