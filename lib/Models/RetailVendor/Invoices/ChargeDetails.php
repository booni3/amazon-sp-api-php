...
class ChargeDetails implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'type' => 'string',
'description' => 'string',
'charge_amount' => '\ClouSale\AmazonSellingPartnerAPI\Models\RetailVendor\Invoices\Money',
...
self::TYPE_ENVIRONMENTAL_PROTECTION_SERVICE,        ];
     ...
     * Sets charge_amount
     *
     * @param \ClouSale\AmazonSellingPartnerAPI\Models\RetailVendor\Invoices\Money $charge_amount charge_amount
     *
     * @return $this
     */
     ...
     * Sets tax_details
     *
     * @param \ClouSale\AmazonSellingPartnerAPI\Models\RetailVendor\Invoices\TaxDetails[] $tax_details Tax amount details applied on this charge.
     *
     * @return $this
     */
