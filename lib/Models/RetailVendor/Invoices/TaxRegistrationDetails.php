...
self::TAX_REGISTRATION_TYPE_GST,        ];
     ...
     *
     * @param string $tax_registration_type Tax Registration Type for the entity, can be either VAT or GST.
     *
     * @return $this
     */
     ...
     *
     * @param string $tax_registration_number Tax Registration Number for the entity, example VAT id.
     *
     * @return $this
     */
