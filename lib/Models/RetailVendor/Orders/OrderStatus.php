...
'item_status' => '\ClouSale\AmazonSellingPartnerAPI\Models\RetailVendor\Orders\ItemStatus'    ];
...
self::PURCHASE_ORDER_STATUS_CLOSED,        ];
     ...
     *
     * @param string $purchase_order_number This field will contain the buyer's Purchase Order Number for this order. Formatting Notes: 8-character alpha-numeric code.
     *
     * @return $this
     */
     ...
     *
     * @param string $purchase_order_status This field will contain the current status of the buyer's Purchase Order for this order. Order Status is 'closed' when buyer has received all the items of the PO.
     *
     * @return $this
     */
     ...
     *
     * @param \DateTime $last_updated_date The date when the purchase order was last updated. This field is expected to be in ISO-8601 date/time format, for example:2018-07-16T23:00:00Z/ 2018-07-16T23:00:00-05:00 /2018-07-16T23:00:00-08:00. If no time zone is specified, UTC should be assumed.
     *
     * @return $this
     */
     ...
     * Gets item_status
     *
     * @return \ClouSale\AmazonSellingPartnerAPI\Models\RetailVendor\Orders\ItemStatus
     */
     ...
     * Sets item_status
     *
     * @param \ClouSale\AmazonSellingPartnerAPI\Models\RetailVendor\Orders\ItemStatus $item_status item_status
     *
     * @return $this
     */
