...
'order_details' => '\ClouSale\AmazonSellingPartnerAPI\Models\RetailVendor\Orders\OrderDetails'    ];
...
self::PURCHASE_ORDER_STATE_CLOSED,        ];
     ...
     *
     * @param string $purchase_order_number This field will contain the Amazon Purchase Order Number for this order. Formatting Notes: 8-character alpha-numeric code.
     *
     * @return $this
     */
     ...
     *
     * @param string $purchase_order_state This field will contain the current state of the Purchase Order. State 'New' means purchase order is newly created and needs to be acknowledged by vendor. State 'Acknowledged' means purchase order has acknowledged by vendor. State 'Closed' means purchase order is closed and no further action is required from vendor. PO can be in 'Closed' state due to many reasons like order is rejected by vendor, order is cancelled by Amazon or order is fully received by Amazon
     *
     * @return $this
     */
     ...
     * Gets order_details
     *
     * @return \ClouSale\AmazonSellingPartnerAPI\Models\RetailVendor\Orders\OrderDetails
     */
     ...
     * Sets order_details
     *
     * @param \ClouSale\AmazonSellingPartnerAPI\Models\RetailVendor\Orders\OrderDetails $order_details order_details
     *
     * @return $this
     */
