 ...
 *
 * @category Class
 * @description Details of item being acknowledged
 * @package  ClouSale\AmazonSellingPartnerAPI
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
...
'ordered_quantity' => '\ClouSale\AmazonSellingPartnerAPI\Models\RetailVendor\Orders\ItemQuantity',
'net_cost' => '\ClouSale\AmazonSellingPartnerAPI\Models\RetailVendor\Orders\Money',
'list_price' => '\ClouSale\AmazonSellingPartnerAPI\Models\RetailVendor\Orders\Money',
'discount_multiplier' => 'string',
'item_acknowledgements' => '\ClouSale\AmazonSellingPartnerAPI\Models\RetailVendor\Orders\OrderItemAcknowledgement[]'    ];
...
'item_acknowledgements' => 'getItemAcknowledgements'    ];
     ...
     *
     * @param \ClouSale\AmazonSellingPartnerAPI\Models\RetailVendor\Orders\ItemQuantity $ordered_quantity ordered_quantity
     *
     * @return $this
     */
     ...
     * Gets net_cost
     *
     * @return \ClouSale\AmazonSellingPartnerAPI\Models\RetailVendor\Orders\Money
     */
     ...
     * Sets net_cost
     *
     * @param \ClouSale\AmazonSellingPartnerAPI\Models\RetailVendor\Orders\Money $net_cost net_cost
     *
     * @return $this
     */
     ...
     * Sets list_price
     *
     * @param \ClouSale\AmazonSellingPartnerAPI\Models\RetailVendor\Orders\Money $list_price list_price
     *
     * @return $this
     */
     ...
     *
     * @param string $discount_multiplier This is required only if a vendor sells books with a list price. This field will be the discount multiplier that should be applied to the price. This is a multiplier factor to arrive at a  final discounted price. A multiplier of .90 would be the factor if a 10% discount is given.
     *
     * @return $this
     */
     ...
     *
     * @return \ClouSale\AmazonSellingPartnerAPI\Models\RetailVendor\Orders\OrderItemAcknowledgement[]
     */
     ...
     *
     * @param \ClouSale\AmazonSellingPartnerAPI\Models\RetailVendor\Orders\OrderItemAcknowledgement[] $item_acknowledgements This is used to indicate acknowledged quantity
     *
     * @return $this
     */
